      ...
      <Dialog as="div" className="relative z-10" onClose={onClose}>
        ...
        <div className="fixed inset-0 z-10 overflow-y-auto flex justify-center items-center">
          <div className="flex min-h-full w-[600px] items-end justify-center p-4 text-center sm:items-center sm:p-0">
            ...
            >
              <Dialog.Panel className="relative transform overflow-hidden rounded-lg bg-white-100 text-left shadow-xl transition-all sm:my-8 w-full min-h-[320px] max-h-[500px]">
                {children}
              </Dialog.Panel>
            </Transition.Child>
          </div>
