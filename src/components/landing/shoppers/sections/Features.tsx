...
export default function Features() {
  return (
    <div className="relative flex flex-col overflow-hidden bg-alabaster px-[1.4rem] py-[50px] sm:px-[6.25rem] sm:py-[80px] gap-[90px] md:gap-[100px] lg:gap-[30px]">
      <FeaturesBg />
        ...
        <div className="flex flex-col gap-[20px]">
          ...
          <div className="w-full sm:w-[60%]">
            <p className="text-[1.2rem]">
              ...
              visualize your dream garment in 360 degrees, try it on virtually,
              and see how it looks from every angle before you buy.
            </p>
          </div>
        </div>
      </motion.div>
