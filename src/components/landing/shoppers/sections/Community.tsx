...
export default function Community() {
  return (
    <>
      <div className="flex flex-col gap-[30px] bg-light px-[1.4rem] py-[50px] sm:px-[6.25rem] sm:py-[80px]">
        <div
        ...
        >
          <div className="z-[2] flex flex-col gap-[20px] p-[1rem] sm:p-[4rem]">
            ...
            <p className="text-[1rem] text-white sm:text-[1.5625rem]">
              ...
              inspiration, and discover exclusive offers and trends. Be part of
              the Glimere community and experience the joy of unique fashion
              together.
            </p>
            <Link
