  ...
  return (
    <>
      <motion.div
        ...
        animate={{
          scale: selectedCurrent && parentIndex !== selectedCurrent() ? 0.7 : 1,
        }}
      ...
      >
        <div className="relative max-w-[39rem] min-w-[25rem] h-full flex flex-col items-center">
          ...
          <AnimatePresence>
            <>
              <div className="absolute right-[20%] z-[3] h-full">
                <SliderPageIndicator
                  totalCount={count}
                  current={current}
                  direction="vertical"
          ...
          >
            ...
            <div className="absolute flex flex-col gap-[20px] bottom-[20%] right-[20%] z-[3]">
