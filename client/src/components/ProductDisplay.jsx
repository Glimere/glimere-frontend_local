...
export default function ProductDisplay(props) {
  ...
  return (
    <>
      <div className="w-full h-[70vh] mb-[30px] px-[18px] sm:px-[60px] sm:h-[90vh] bg-[#FFF7E9] grid grid-rows-6 sm:grid-rows-4 grid-cols-4 sm:grid-cols-3 grid-flow-col gap-3 sm:gap-5">
        ...
        >
          <div className="p-[20px] sm:p-[30px] h-full w-full bg-[#00000057] flex justify-start items-center ">
            <div className="w-[100%] sm:w-[70%]">
              <p className='text-[10px] sm:text-[12px] text-white-100 mb-[5px]'>{adsUrl.adsHeading1}</p>
              <h1 className='text-[12px] sm:text-[18px] text-white-100 font-bold'>{adsUrl.adsTrigger1}</h1>
              <p className='text-white-100 text-[12px] sm:text-[15px]'>From $<span>{adsUrl.adsNumber1}.99</span></p>
              <button className='px-[20px] py-[7px] bg-[#9D5C0D] text-white-100 rounded-full mt-[10px]'>Explore</button>
            </div>
          </div>
        </div>
        ...
        >
          <div className="p-[20px] sm:p-[30px] h-full w-full bg-[#00000057] flex justify-start items-center ">
            <div className="w-[100%] sm:w-[70%]">
              <p className='text-[10px] sm:text-[12px] text-white-100 mb-[5px]'>{adsUrl.adsHeading4}</p>
              <h1 className='text-[15px] sm:text-[18px] text-white-100 font-bold'>{adsUrl.adsTrigger4}</h1>
              <p className='text-white-100 text-[15px]'>From $<span>{adsUrl.adsNumber4}.99</span></p>
              <button className='px-[20px] py-[7px] bg-[#9D5C0D] text-white-100 rounded-full mt-[10px]'>Shop Now</button>
            </div>
          </div>
        </div>
