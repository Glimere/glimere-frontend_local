...
export default function ViewProduct() {
  ...
  return (
    <div className='h-[100vh] flex flex-row pt-[80px] w-full relative z-[5]'>
      ...
      <div className="w-[43%] h-full pt-[80px] flex flex-col bg-[#FFF7E9] right-0 bottom-0 fixed -z-10">
        {/* <div className="w-full h-[70px] bg-[#f7d08a]"></div> */}
        <div className="w-full h-full px-[70px] pb-[50px] pt-[20px] flex flex-col  justify-between">
